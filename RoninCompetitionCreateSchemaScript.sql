...
DROP TABLE IF EXISTS athlete, style, gym, gym_style, referee, referee_style, athlete, athlete_record, athlete_gym, 
athlete_score, bout, outcome, athlete_style, competition, athlete_competition, referee_style, following CASCADE; 
...
CREATE TRIGGER update_gym_style_updated_dt
    BEFORE UPDATE ON gym_style
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_dt_column();
